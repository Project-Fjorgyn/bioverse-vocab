...
export function LoadSchema(path) {
  return {
    ...
    betula: referenceArt(require('../../../assets/vocab/data/trees/betulaceae/betula/schema.json'), ARTWORK),
    carpinus: referenceArt(require('../../../assets/vocab/data/trees/betulaceae/carpinus/schema.json'), ARTWORK),
    ostrya: referenceArt(require('../../../assets/vocab/data/trees/betulaceae/ostrya/schema.json'), ARTWORK),
    ...
    kalmia: referenceArt(require('../../../assets/vocab/data/trees/ericaceae/kalmia/schema.json'), ARTWORK),
    rhododendron: referenceArt(require('../../../assets/vocab/data/trees/ericaceae/rhododendron/schema.json'), ARTWORK),
    fagaceae: referenceArt(require('../../../assets/vocab/data/trees/fagaceae/schema.json'), ARTWORK),
    castanea: referenceArt(require('../../../assets/vocab/data/trees/fagaceae/castanea/schema.json'), ARTWORK),
    fagus: referenceArt(require('../../../assets/vocab/data/trees/fagaceae/fagus/schema.json'), ARTWORK),
    quercus: referenceArt(require('../../../assets/vocab/data/trees/fagaceae/quercus/schema.json'), ARTWORK),
    ...
    amelanchier: referenceArt(require('../../../assets/vocab/data/trees/rosaceae/amelanchier/schema.json'), ARTWORK),
    prunus: referenceArt(require('../../../assets/vocab/data/trees/rosaceae/prunus/schema.json'), ARTWORK),
    sorbus: referenceArt(require('../../../assets/vocab/data/trees/rosaceae/sorbus/schema.json'), ARTWORK),
    ...
    populus: referenceArt(require('../../../assets/vocab/data/trees/salicaceae/populus/schema.json'), ARTWORK),
    salix: referenceArt(require('../../../assets/vocab/data/trees/salicaceae/salix/schema.json'), ARTWORK),
